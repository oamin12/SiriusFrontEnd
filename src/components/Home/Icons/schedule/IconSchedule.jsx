...
import { edit_button } from "./inlinestylesheet_schedule";
...
function IconSchedule(props)
 {
  ...
  function closeschedule() {
    ...
    if (props.FlagToOpenDraftsFromTweetButton !== undefined) {
      props.set_FlagToOpenDraftsFromTweetButton(false);
    }
    if (flag_confirm === 0) {
    ...
    <div>
      {props.opendraftspage !== true && (
        <div>
          ...
          props.FlagToOpenDraftsFromTweetButton === true ? (
            <div>
              <Dialog
                open={Open || props.FlagToOpenDraftsFromTweetButton}
              ...
              >
                <DialogContent sx={style1}>
                  <div className="firstdiv">
                    ...
                    <Button sx={edit_button}>Edit</Button>
      ...
      {/* will be opened from the tweet in the side bar */}
      {props.opendraftspage === true && (
        <div>
          {TweetButtonPopUpPage === 1 && <SideBar TweetButtonPopUpPage={1} />}
        </div>
      )}
    </div>
  );
