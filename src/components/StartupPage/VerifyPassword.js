  ...
  async function Verify() {
    ...
    try {
      response = await axios
        .patch("http://34.236.108.123:3000/signup-confirm/" + dataValue.code)
        .then((res) => res.data);
  ...
  return (
    <div className="Verify">
      ...
      <div className="containerv">
        <ArrowBackIcon className="backav" onClick={() => navigate("/")} />
        <h1 className="h1v">We sent you a code</h1>
        <p className="infov">Enter it below to reset your password.</p>
        <input
          className="boxv"
          name="code"
